...
<div ref={contextRef}>
             ...
             className="flex flex-col justify-center gap-12 pt-16 sm:gap-16">
                <p className='text-sm  font-light tracking-[0.5rem] uppercase px-10 text=black'>
                  404 no bugs found</p>
                <div className="px-10">
                    <h1 className="flex flex-col font-serif flex-wrap gap-12  text-black uppercase banner-text-responsive sm:gap-16 md:block mb-5">
                        Shivangi Keshari
                        Lorem, ipsum.
                    </h1>
                </div>
  ...
  <div className="absolute inset-x-0 border-t-2"/>
    <div className="py-2 sm:py-16 text-end">
      <AnimatedTextLines 
      text={aboutText}
      className="font-light text-2xl text-bold uppercase value-text-responsive" />
    </div>
    
  </div>
</div> */}
<figure className="absolute inset-0 -s-50"
