...
function Hero() {
  ...
  return (
    <section  id="home" className="min-h-screen  flex flex-col justify-end relative">
        <div className='absolute top-10 left-10 '><img src={skLogo} className=' h-30 lg:h-45 xl:h-55 '  alt="Sk" /></div>
